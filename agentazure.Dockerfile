...
RUN apt-get update \
&& apt-get install -y --no-install-recommends ca-certificates curl jq iputils-ping libcurl4 libicu60 libunwind8 netcat apt-utils wget unzip openjdk-8-jdk curl maven git-all sudo python3 python3-pip
